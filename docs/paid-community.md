...
| `GET /api/community/status` | Check current user's community access | Logged-in user |
...
| `POST /api/admin/community/revoke` | Revoke a user's community access | Super admin |
